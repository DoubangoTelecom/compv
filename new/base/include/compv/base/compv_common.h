...
enum COMPV_ARRAY_TYPE {
	COMPV_ARRAY_TYPE_RAW,
	COMPV_ARRAY_TYPE_PIXELS
};

enum COMPV_ARRAY_SUBTYPE {
	COMPV_ARRAY_SUBTYPE_RAW,

	COMPV_ARRAY_SUBTYPE_PIXELS_R8G8B8, // RGB24
	COMPV_ARRAY_SUBTYPE_PIXELS_B8G8R8, // BGR8
	COMPV_ARRAY_SUBTYPE_PIXELS_R8G8B8A8, // RGB32
	COMPV_ARRAY_SUBTYPE_PIXELS_B8G8R8A8, // BGRA32
	COMPV_ARRAY_SUBTYPE_PIXELS_A8B8G8R8, // ABGR32
	COMPV_ARRAY_SUBTYPE_PIXELS_A8R8G8B8, // ARGB32
	COMPV_ARRAY_SUBTYPE_PIXELS_GRAYSCALE, // Y-only
	COMPV_ARRAY_SUBTYPE_PIXELS_I420, // http://www.fourcc.org/yuv.php#IYUV
	COMPV_ARRAY_SUBTYPE_PIXELS_IYUV = COMPV_ARRAY_SUBTYPE_PIXELS_I420
};

enum COMPV_PIXEL_FORMAT {
	COMPV_PIXEL_FORMAT_NONE = COMPV_ARRAY_SUBTYPE_RAW,
	COMPV_PIXEL_FORMAT_R8G8B8 = COMPV_ARRAY_SUBTYPE_PIXELS_R8G8B8, // RGB24
	COMPV_PIXEL_FORMAT_B8G8R8 = COMPV_ARRAY_SUBTYPE_PIXELS_B8G8R8, // BGR8
	COMPV_PIXEL_FORMAT_R8G8B8A8 = COMPV_ARRAY_SUBTYPE_PIXELS_R8G8B8A8, // RGB32
	COMPV_PIXEL_FORMAT_B8G8R8A8 = COMPV_ARRAY_SUBTYPE_PIXELS_B8G8R8A8, // BGRA32
	COMPV_PIXEL_FORMAT_A8B8G8R8 = COMPV_ARRAY_SUBTYPE_PIXELS_A8B8G8R8, // ABGR32
	COMPV_PIXEL_FORMAT_A8R8G8B8 = COMPV_ARRAY_SUBTYPE_PIXELS_A8R8G8B8, // ARGB32
	COMPV_PIXEL_FORMAT_GRAYSCALE = COMPV_ARRAY_SUBTYPE_PIXELS_GRAYSCALE, // Y-only
	COMPV_PIXEL_FORMAT_I420 = COMPV_ARRAY_SUBTYPE_PIXELS_I420, // http://www.fourcc.org/yuv.php#IYUV
	COMPV_PIXEL_FORMAT_IYUV = COMPV_ARRAY_SUBTYPE_PIXELS_IYUV
};
