...
std::string GBDT::ModelToIfElse(int num_iteration) const {
  ...
  str_buf << "#include <compv/base/ml/LightGBM-stable-f1f18dd/utils/common.h>" << '\n';
  str_buf << "#include <compv/base/ml/LightGBM-stable-f1f18dd/objective_function.h>" << '\n';
  str_buf << "#include <compv/base/ml/LightGBM-stable-f1f18dd/metric.h>" << '\n';
  str_buf << "#include <compv/base/ml/LightGBM-stable-f1f18dd/prediction_early_stop.h>" << '\n';
