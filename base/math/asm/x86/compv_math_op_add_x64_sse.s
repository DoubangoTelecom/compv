...
global sym(CompVMathOpAddAdd_32f32f32f_Asm_X64_SSE2)
...
sym(CompVMathOpAddAdd_32f32f32f_Asm_X64_SSE2):
	push rbp
	mov rbp, rsp
	...
	.LoopHeight:
		...
		.LoopWidth16:
			...
			addps xmm0, [Bptr + (i + 0)*COMPV_YASM_FLOAT32_SZ_BYTES]
			addps xmm1, [Bptr + (i + 4)*COMPV_YASM_FLOAT32_SZ_BYTES]
			addps xmm2, [Bptr + (i + 8)*COMPV_YASM_FLOAT32_SZ_BYTES]
			addps xmm3, [Bptr + (i + 12)*COMPV_YASM_FLOAT32_SZ_BYTES]
