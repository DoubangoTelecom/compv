...
global sym(CompVMathOpAddAdd_32f32f32f_Asm_X64_AVX)
...
sym(CompVMathOpAddAdd_32f32f32f_Asm_X64_AVX):
	vzeroupper
	push rbp
	mov rbp, rsp
	...
	.LoopHeight:
		...
		.LoopWidth32:
			...
			vaddps ymm0, [Bptr + (i + 0)*COMPV_YASM_FLOAT32_SZ_BYTES]
			vaddps ymm1, [Bptr + (i + 8)*COMPV_YASM_FLOAT32_SZ_BYTES]
			vaddps ymm2, [Bptr + (i + 16)*COMPV_YASM_FLOAT32_SZ_BYTES]
			vaddps ymm3, [Bptr + (i + 24)*COMPV_YASM_FLOAT32_SZ_BYTES]
