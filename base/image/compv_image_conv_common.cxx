...
#define AV 0
////// RGBA -> YUV //////
COMPV_ALIGN_DEFAULT() int8_t kRGBAToYUV_YCoeffs8[] = {
...
COMPV_ALIGN_DEFAULT() int8_t kRGBAToYUV_UCoeffs8[] = {
...
COMPV_ALIGN_DEFAULT() int8_t kRGBAToYUV_VCoeffs8[] = {
...
COMPV_ALIGN_DEFAULT() int8_t kRGBAToYUV_UVCoeffs8[] = { // U and V interleaved: Each appear #1 time: UVUVUVUV....
	RU, GU, BU, AU, RV, GV, BV, AV, RU, GU, BU, AU, RV, GV, BV, AV,
	RU, GU, BU, AU, RV, GV, BV, AV, RU, GU, BU, AU, RV, GV, BV, AV,
};
COMPV_ALIGN_DEFAULT() int8_t kRGBAToYUV_U2V2Coeffs8[] = { // U and V interleaved: Each appear #2 times: UUVVUUVVUUVV....
	RU, GU, BU, AU, RU, GU, BU, AU, RV, GV, BV, AV, RV, GV, BV, AV,
	RU, GU, BU, AU, RU, GU, BU, AU, RV, GV, BV, AV, RV, GV, BV, AV,
};

COMPV_ALIGN_DEFAULT() int8_t kRGBAToYUV_U4V4Coeffs8[] = { // AVX-only: U and V interleaved: Each appear #4 times: UUUUVVVVUUUUVVVV.....
	RU, GU, BU, AU, RU, GU, BU, AU, RU, GU, BU, AU, RU, GU, BU, AU,
	RV, GV, BV, AV, RV, GV, BV, AV, RV, GV, BV, AV, RV, GV, BV, AV,
};
////// ARGB -> YUV //////
COMPV_ALIGN_DEFAULT() int8_t kARGBToYUV_YCoeffs8[] = {
...
COMPV_ALIGN_DEFAULT() int8_t kARGBToYUV_UCoeffs8[] = {
...
COMPV_ALIGN_DEFAULT() int8_t kARGBToYUV_VCoeffs8[] = {
...
////// BGRA -> YUV //////
COMPV_ALIGN_DEFAULT() int8_t kBGRAToYUV_YCoeffs8[] = {
...
COMPV_ALIGN_DEFAULT() int8_t kBGRAToYUV_UCoeffs8[] = {
...
COMPV_ALIGN_DEFAULT() int8_t kBGRAToYUV_VCoeffs8[] = {
...
////// ABGR -> YUV //////
COMPV_ALIGN_DEFAULT() int8_t kABGRToYUV_YCoeffs8[] = {
...
COMPV_ALIGN_DEFAULT() int8_t kABGRToYUV_UCoeffs8[] = {
...
COMPV_ALIGN_DEFAULT() int8_t kABGRToYUV_VCoeffs8[] = {
...
////// RGB -> YUV //////
COMPV_ALIGN_DEFAULT() int8_t kRGBToYUV_YCoeffs8[] = {
...
COMPV_ALIGN_DEFAULT() int8_t kRGBToYUV_UCoeffs8[] = {
...
COMPV_ALIGN_DEFAULT() int8_t kRGBToYUV_VCoeffs8[] = {
...
////// BGR -> YUV //////
COMPV_ALIGN_DEFAULT() int8_t kBGRToYUV_YCoeffs8[] = {
...
COMPV_ALIGN_DEFAULT() int8_t kBGRToYUV_UCoeffs8[] = {
...
COMPV_ALIGN_DEFAULT() int8_t kBGRToYUV_VCoeffs8[] = {
...
B = (37Y' + 65U' + 0V') >> 5
*/
COMPV_ALIGN_DEFAULT() int8_t kYUVToRGBA_RCoeffs8[] = { // Extended with a zero to have #4 coeffs: k0, k1, k2, 0
	37, 0, 51, 0, 37, 0, 51, 0, 37, 0, 51, 0, 37, 0, 51, 0, // 128bits SSE register
	37, 0, 51, 0, 37, 0, 51, 0, 37, 0, 51, 0, 37, 0, 51, 0, // 256bits AVX register
};
COMPV_ALIGN_DEFAULT() int8_t kYUVToRGBA_GCoeffs8[] = { // Extended with a zero to have #4 coeffs: k0, k1, k2, 0
...
COMPV_ALIGN_DEFAULT() int8_t kYUVToRGBA_BCoeffs8[] = { // Extended with a zero to have #4 coeffs: k0, k1, k2, 0
...
COMPV_ALIGN_DEFAULT() int32_t kShuffleEpi8_RgbToRgba_i32[] = {  // To be used with _mm_shuffle_epi8
...
COMPV_ALIGN_DEFAULT() int32_t kShuffleEpi8_Yuyv422ToYuv_i32[] = {  // To be used with _mm_shuffle_epi8
...
COMPV_ALIGN_DEFAULT() int32_t kShuffleEpi8_Uyvy422ToYuv_i32[] { // To be used with _mm_shuffle_epi8
...
COMPV_ALIGN_DEFAULT() uint16_t kRGB565ToYUV_RMask_u16[] = {
...
COMPV_ALIGN_DEFAULT() uint16_t kRGB565ToYUV_GMask_u16[] = {
...
COMPV_ALIGN_DEFAULT() uint16_t kRGB565ToYUV_BMask_u16[] = {
