...
#define myrecip(x) _mm_div_ps(vec01f, x) /*_mm_rcp_ps(x)*/
	...
	for (j = 0; j < height; ++j) {
		for (i = 0, k = 0; i < width; i += 64, k += 48) { // 64 = (16 * 4), 48 = (16 * 3)
			...
			vec0f = _mm_castsi128_ps(_mm_andnot_si128(_mm_cmpeq_epi32(_mm_castps_si128(vec0f), vecZero), _mm_castps_si128(myrecip(vec0f))));
			vec1f = _mm_castsi128_ps(_mm_andnot_si128(_mm_cmpeq_epi32(_mm_castps_si128(vec1f), vecZero), _mm_castps_si128(myrecip(vec1f))));
			vec2f = _mm_castsi128_ps(_mm_andnot_si128(_mm_cmpeq_epi32(_mm_castps_si128(vec2f), vecZero), _mm_castps_si128(myrecip(vec2f))));
			vec3f = _mm_castsi128_ps(_mm_andnot_si128(_mm_cmpeq_epi32(_mm_castps_si128(vec3f), vecZero), _mm_castps_si128(myrecip(vec3f))));
			...
			vec2 = _mm_andnot_si128(_mm_cmpeq_epi32(vec2, vecZero), _mm_castps_si128(myrecip(_mm_castsi128_ps(vec2))));
			vec3 = _mm_andnot_si128(_mm_cmpeq_epi32(vec3, vecZero), _mm_castps_si128(myrecip(_mm_castsi128_ps(vec3))));
