...
#define COMPV_32xRGB_TO_32xRGBA_AVX2_FAST(rgb32Ptr_, ymmRGBA0_, ymmRGBA1_, ymmRGBA2_, ymmRGBA3_, ymmABCDDEFG_, ymmCDEFFGHX_, ymmXXABBCDE_, ymmMaskRgbToRgba_) \
	_mm256_store_si256(&ymmRGBA3_, _mm256_load_si256(reinterpret_cast<const __m256i*>(rgb32Ptr_ + 32))); \
	_mm256_store_si256(&ymmRGBA1_, _mm256_permute2x128_si256(ymmRGBA3_, ymmRGBA3_, 0x11)); \
	_mm256_store_si256(&ymmRGBA3_, _mm256_permutevar8x32_epi32(_mm256_load_si256(reinterpret_cast<const __m256i*>(rgb32Ptr_ + 64)), ymmCDEFFGHX_)); \
	_mm256_store_si256(&ymmRGBA1_, _mm256_permute2x128_si256(ymmRGBA1_, _mm256_load_si256(reinterpret_cast<const __m256i*>(rgb32Ptr_ + 64)), 0x20)); \
	...
	_mm256_store_si256(&ymmRGBA0_, _mm256_permute4x64_epi64(_mm256_load_si256(reinterpret_cast<const __m256i*>(rgb32Ptr_ + 0)), 0xff)); \
	_mm256_store_si256(&ymmRGBA1_, _mm256_permutevar8x32_epi32(_mm256_load_si256(reinterpret_cast<const __m256i*>(rgb32Ptr_ + 32)), ymmXXABBCDE_)); \
	...
	_mm256_store_si256(&ymmRGBA0_, _mm256_permutevar8x32_epi32(_mm256_load_si256(reinterpret_cast<const __m256i*>(rgb32Ptr_ + 0)), ymmABCDDEFG_)); \
...
#define COMPV_32xRGBA_TO_32xLUMA_AVX2(ymmRGBA0_, ymmRGBA1_, ymmRGBA2_, ymmRGBA3_, ymmYCoeffs_, ymm16_, ymmAEBFCGDH_, outYPtr_) \
	_mm256_store_si256(&ymmRGBA0_, _mm256_hadd_epi16(_mm256_maddubs_epi16(ymmRGBA0_, ymmYCoeffs_), _mm256_maddubs_epi16(ymmRGBA1_, ymmYCoeffs_))); /* hadd(ABCD) -> ACBD */ \
	_mm256_store_si256(&ymmRGBA2_, _mm256_hadd_epi16(_mm256_maddubs_epi16(ymmRGBA2_, ymmYCoeffs_), _mm256_maddubs_epi16(ymmRGBA3_, ymmYCoeffs_))); /* hadd(EFGH) -> EGFH */ \
	_mm256_store_si256(&ymmRGBA0_, _mm256_srai_epi16(ymmRGBA0_, 7)); /* >> 7 */ \
	_mm256_store_si256(&ymmRGBA2_, _mm256_srai_epi16(ymmRGBA2_, 7)); /* >> 7 */ \
	_mm256_store_si256(&ymmRGBA0_, _mm256_add_epi16(ymmRGBA0_, ymm16_)); /* + 16 */ \
	_mm256_store_si256(&ymmRGBA2_, _mm256_add_epi16(ymmRGBA2_, ymm16_)); /* + 16 */ \
	_mm256_store_si256(&ymmRGBA0_, _mm256_packus_epi16(ymmRGBA0_, ymmRGBA2_)); /* Saturate(I16 -> U8): packus(ACBD, EGFH) -> AEBFCGDH */ \
	_mm256_store_si256(&ymmRGBA0_, _mm256_permutevar8x32_epi32(ymmRGBA0_, ymmAEBFCGDH_)); /* Final Permute */ \
...
#define COMPV_32xRGBA_TO_32xCHROMA1_AVX2(ymmRGBA0_, ymmRGBA1_, ymmRGBA2_, ymmRGBA3_, ymm0C_, ymm1C_, ymmCCoeffs_, ymm128_, ymmAEBFCGDH_,outCPtr_) \
	_mm256_store_si256(&ymm0C_, _mm256_hadd_epi16(_mm256_maddubs_epi16(ymmRGBA0_, ymmCCoeffs_), _mm256_maddubs_epi16(ymmRGBA1_, ymmCCoeffs_))); \
	_mm256_store_si256(&ymm1C_, _mm256_hadd_epi16(_mm256_maddubs_epi16(ymmRGBA2_, ymmCCoeffs_), _mm256_maddubs_epi16(ymmRGBA3_, ymmCCoeffs_))); \
	_mm256_store_si256(&ymm0C_, _mm256_srai_epi16(ymm0C_, 8)); /* >> 8 */ \
	_mm256_store_si256(&ymm1C_, _mm256_srai_epi16(ymm1C_, 8)); /* >> 8 */ \
	_mm256_store_si256(&ymm0C_, _mm256_add_epi16(ymm0C_, ymm128_)); /* + 128 */ \
	_mm256_store_si256(&ymm1C_, _mm256_add_epi16(ymm1C_, ymm128_)); /* + 128 */ \
	_mm256_store_si256(&ymm0C_, _mm256_packus_epi16(ymm0C_, ymm1C_)); /* packus(ACBD, EGFH) -> AEBFCGDH */ \
	_mm256_store_si256(&ymm0C_, _mm256_permutevar8x32_epi32(ymm0C_, ymmAEBFCGDH_)); /* Final Permute */ \
...
#endif
void CompVImageConvRgb24family_to_y_Intrin_AVX2(COMPV_ALIGNED(AVX) const uint8_t* rgb32Ptr, COMPV_ALIGNED(AVX) uint8_t* outYPtr, compv_uscalar_t width, compv_uscalar_t height, COMPV_ALIGNED(AVX) compv_uscalar_t stride,
	COMPV_ALIGNED(DEFAULT) const int8_t* kRGBfamilyToYUV_YCoeffs8)
{
	...
	for (j = 0; j < height; ++j) {
		for (i = 0; i < width; i += 32) {
			...
			COMPV_32xRGB_TO_32xRGBA_AVX2_FAST(rgb32Ptr, ymmRGBA0, ymmRGBA1, ymmRGBA2, ymmRGBA3, ymmABCDDEFG, ymmCDEFFGHX, ymmXXABBCDE, ymmMaskRgbToRgba);
	...
	COMPV_ALIGNED(DEFAULT) const int8_t* kRGBAfamilyToYUV_YCoeffs8)
{
	...
	_mm256_store_si256(&ymmYCoeffs, _mm256_load_si256(reinterpret_cast<const __m256i*>(kRGBAfamilyToYUV_YCoeffs8)));
	_mm256_store_si256(&ymm16, _mm256_load_si256(reinterpret_cast<const __m256i*>(k16_i16)));
	_mm256_store_si256(&ymmAEBFCGDH, _mm256_load_si256(reinterpret_cast<const __m256i*>(kAVXPermutevar8x32_AEBFCGDH_i32)));
	...
	for (j = 0; j < height; ++j) {
		for (i = 0; i < width; i += 32) {
			_mm256_store_si256(&ymmRGBA0, _mm256_load_si256(reinterpret_cast<const __m256i*>(rgb32Ptr + 0)));
			_mm256_store_si256(&ymmRGBA1, _mm256_load_si256(reinterpret_cast<const __m256i*>(rgb32Ptr + 32)));
			_mm256_store_si256(&ymmRGBA2, _mm256_load_si256(reinterpret_cast<const __m256i*>(rgb32Ptr + 64)));
			_mm256_store_si256(&ymmRGBA3, _mm256_load_si256(reinterpret_cast<const __m256i*>(rgb32Ptr + 96)));
			COMPV_32xRGBA_TO_32xLUMA_AVX2(ymmRGBA0, ymmRGBA1, ymmRGBA2, ymmRGBA3, ymmYCoeffs, ymm16, ymmAEBFCGDH, outYPtr);
			outYPtr += 32;
			rgb32Ptr += 128;
		}
...
#	pragma intel optimization_parameter target_arch=avx
#endif
void CompVImageConvRgb24family_to_uv_planar_11_Intrin_AVX2(COMPV_ALIGNED(AVX) const uint8_t* rgb32Ptr, COMPV_ALIGNED(AVX) uint8_t* outUPtr, COMPV_ALIGNED(AVX) uint8_t* outVPtr, compv_uscalar_t width, compv_uscalar_t height, COMPV_ALIGNED(AVX) compv_uscalar_t stride,
	...
	COMPV_ALIGNED(DEFAULT) const int8_t* kRGBAfamilyToYUV_UCoeffs8, COMPV_ALIGNED(DEFAULT) const int8_t* kRGBAfamilyToYUV_VCoeffs8)
{
	...
	_mm256_store_si256(&ymmUCoeffs, _mm256_load_si256(reinterpret_cast<const __m256i*>(kRGBAfamilyToYUV_UCoeffs8)));
	_mm256_store_si256(&ymmVCoeffs, _mm256_load_si256(reinterpret_cast<const __m256i*>(kRGBAfamilyToYUV_VCoeffs8)));
	_mm256_store_si256(&ymm128, _mm256_load_si256(reinterpret_cast<const __m256i*>(k128_i16)));
	_mm256_store_si256(&ymmAEBFCGDH, _mm256_load_si256(reinterpret_cast<const __m256i*>(kAVXPermutevar8x32_AEBFCGDH_i32)));
