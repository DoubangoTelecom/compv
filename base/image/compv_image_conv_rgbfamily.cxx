...
#	if COMPV_ARCH_ARM32
		...
		COMPV_EXTERNC void CompVImageConvRgb565lefamily_to_y_Asm_NEON32(COMPV_ALIGNED(NEON) const uint8_t* rgb565Ptr, COMPV_ALIGNED(NEON) uint8_t* outYPtr, compv_uscalar_t width, compv_uscalar_t height, COMPV_ALIGNED(NEON) compv_uscalar_t stride, COMPV_ALIGNED(DEFAULT) const int8_t* kRGBfamilyToYUV_YCoeffs8);		
		COMPV_EXTERNC void CompVImageConvRgb565befamily_to_y_Asm_NEON32(COMPV_ALIGNED(NEON) const uint8_t* rgb565Ptr, COMPV_ALIGNED(NEON) uint8_t* outYPtr, compv_uscalar_t width, compv_uscalar_t height, COMPV_ALIGNED(NEON) compv_uscalar_t stride, COMPV_ALIGNED(DEFAULT) const int8_t* kRGBfamilyToYUV_YCoeffs8);
...
#	if COMPV_ARCH_ARM64
        COMPV_EXTERNC void CompVImageConvRgb24family_to_y_Asm_NEON64(COMPV_ALIGNED(NEON) const uint8_t* rgb24Ptr, COMPV_ALIGNED(NEON) uint8_t* outYPtr, compv_uscalar_t width, compv_uscalar_t height, COMPV_ALIGNED(NEON) compv_uscalar_t stride, COMPV_ALIGNED(DEFAULT) const int8_t* kRGBfamilyToYUV_YCoeffs8);
        COMPV_EXTERNC void CompVImageConvRgba32family_to_y_Asm_NEON64(COMPV_ALIGNED(NEON) const uint8_t* rgb32Ptr, COMPV_ALIGNED(NEON) uint8_t* outYPtr, compv_uscalar_t width, compv_uscalar_t height, COMPV_ALIGNED(NEON) compv_uscalar_t stride, COMPV_ALIGNED(DEFAULT) const int8_t* kRGBfamilyToYUV_YCoeffs8);
        COMPV_EXTERNC void CompVImageConvArgb32family_to_y_Asm_NEON64(COMPV_ALIGNED(NEON) const uint8_t* rgb32Ptr, COMPV_ALIGNED(NEON) uint8_t* outYPtr, compv_uscalar_t width, compv_uscalar_t height, COMPV_ALIGNED(NEON) compv_uscalar_t stride, COMPV_ALIGNED(DEFAULT) const int8_t* kRGBfamilyToYUV_YCoeffs8);
        COMPV_EXTERNC void CompVImageConvRgb565lefamily_to_y_Asm_NEON64(COMPV_ALIGNED(NEON) const uint8_t* rgb565Ptr, COMPV_ALIGNED(NEON) uint8_t* outYPtr, compv_uscalar_t width, compv_uscalar_t height, COMPV_ALIGNED(NEON) compv_uscalar_t stride, COMPV_ALIGNED(DEFAULT) const int8_t* kRGBfamilyToYUV_YCoeffs8);
        COMPV_EXTERNC void CompVImageConvRgb565befamily_to_y_Asm_NEON64(COMPV_ALIGNED(NEON) const uint8_t* rgb565Ptr, COMPV_ALIGNED(NEON) uint8_t* outYPtr, compv_uscalar_t width, compv_uscalar_t height, COMPV_ALIGNED(NEON) compv_uscalar_t stride, COMPV_ALIGNED(DEFAULT) const int8_t* kRGBfamilyToYUV_YCoeffs8);
        COMPV_EXTERNC void CompVImageConvRgb24family_to_uv_planar_11_Asm_NEON64(COMPV_ALIGNED(NEON) const uint8_t* rgb24Ptr, COMPV_ALIGNED(NEON) uint8_t* outUPtr, COMPV_ALIGNED(NEON) uint8_t* outVPtr, compv_uscalar_t width, compv_uscalar_t height, COMPV_ALIGNED(NEON) compv_uscalar_t stride, COMPV_ALIGNED(DEFAULT) const int8_t* kRGBfamilyToYUV_UCoeffs8, COMPV_ALIGNED(DEFAULT) const int8_t* kRGBfamilyToYUV_VCoeffs8);
        COMPV_EXTERNC void CompVImageConvRgba32family_to_uv_planar_11_Asm_NEON64(COMPV_ALIGNED(NEON) const uint8_t* rgb32Ptr, COMPV_ALIGNED(NEON) uint8_t* outUPtr, COMPV_ALIGNED(NEON) uint8_t* outVPtr, compv_uscalar_t width, compv_uscalar_t height, COMPV_ALIGNED(NEON) compv_uscalar_t stride, COMPV_ALIGNED(DEFAULT) const int8_t* kRGBfamilyToYUV_UCoeffs8, COMPV_ALIGNED(DEFAULT) const int8_t* kRGBfamilyToYUV_VCoeffs8);
        COMPV_EXTERNC void CompVImageConvArgb32family_to_uv_planar_11_Asm_NEON64(COMPV_ALIGNED(NEON) const uint8_t* rgb32Ptr, COMPV_ALIGNED(NEON) uint8_t* outUPtr, COMPV_ALIGNED(NEON) uint8_t* outVPtr, compv_uscalar_t width, compv_uscalar_t height, COMPV_ALIGNED(NEON) compv_uscalar_t stride, COMPV_ALIGNED(DEFAULT) const int8_t* kRGBfamilyToYUV_UCoeffs8, COMPV_ALIGNED(DEFAULT) const int8_t* kRGBfamilyToYUV_VCoeffs8);
        COMPV_EXTERNC void CompVImageConvRgb565lefamily_to_uv_planar_11_Asm_NEON64(COMPV_ALIGNED(NEON) const uint8_t* rgb565Ptr, COMPV_ALIGNED(NEON) uint8_t* outUPtr, COMPV_ALIGNED(NEON) uint8_t* outVPtr, compv_uscalar_t width, compv_uscalar_t height, COMPV_ALIGNED(NEON) compv_uscalar_t stride, COMPV_ALIGNED(DEFAULT) const int8_t* kRGBfamilyToYUV_UCoeffs8, COMPV_ALIGNED(DEFAULT) const int8_t* kRGBfamilyToYUV_VCoeffs8);
        COMPV_EXTERNC void CompVImageConvRgb565befamily_to_uv_planar_11_Asm_NEON64(COMPV_ALIGNED(NEON) const uint8_t* rgb565Ptr, COMPV_ALIGNED(NEON) uint8_t* outUPtr, COMPV_ALIGNED(NEON) uint8_t* outVPtr, compv_uscalar_t width, compv_uscalar_t height, COMPV_ALIGNED(NEON) compv_uscalar_t stride, COMPV_ALIGNED(DEFAULT) const int8_t* kRGBfamilyToYUV_UCoeffs8, COMPV_ALIGNED(DEFAULT) const int8_t* kRGBfamilyToYUV_VCoeffs8);
#
	...
	COMPV_ALIGNED(DEFAULT) const int8_t* kRGBfamilyToYUV_YCoeffs8)
{
	...
	void(*funcptr)(const uint8_t* rgb24Ptr, uint8_t* outYPtr, compv_uscalar_t width, compv_uscalar_t height, compv_uscalar_t stride, COMPV_ALIGNED(DEFAULT) const int8_t* kRGBfamilyToYUV_YCoeffs8)
		= rgb24family_to_y_C;
#if COMPV_ARCH_X86
	if (CompVCpu::isEnabled(kCpuFlagSSSE3) && COMPV_IS_ALIGNED_SSE(outYPtr) && COMPV_IS_ALIGNED_SSE(stride)) {
		COMPV_EXEC_IFDEF_INTRIN_X86(funcptr = CompVImageConvRgb24family_to_y_Intrin_SSSE3); // No need for 'rgbPtr' to be SSE-aligned
		if (COMPV_IS_ALIGNED_SSE(rgbPtr)) {
			COMPV_EXEC_IFDEF_ASM_X86(funcptr = CompVImageConvRgb24family_to_y_Asm_X86_SSSE3);
		}
	}
	if (CompVCpu::isEnabled(kCpuFlagAVX2) && COMPV_IS_ALIGNED_AVX2(outYPtr) && COMPV_IS_ALIGNED_AVX2(stride)) {
		COMPV_EXEC_IFDEF_INTRIN_X86(funcptr = CompVImageConvRgb24family_to_y_Intrin_AVX2); // No need for 'rgbPtr' to be AVX-aligned
...
#	endif /* COMPV_HAVE_INTEL_IPP */
	...
	if (CompVCpu::isEnabled(kCpuFlagARM_NEON) && COMPV_IS_ALIGNED_NEON(stride)) {
		...
		if (COMPV_IS_ALIGNED_NEON(rgbPtr) && COMPV_IS_ALIGNED_NEON(outYPtr)) {
			COMPV_EXEC_IFDEF_ASM_ARM32(funcptr = CompVImageConvRgb24family_to_y_Asm_NEON32);
			COMPV_EXEC_IFDEF_ASM_ARM64(funcptr = CompVImageConvRgb24family_to_y_Asm_NEON64);
		}
	}
#endif /* COMPV_ARCH_X86 */
	...
	COMPV_ALIGNED(DEFAULT) const int8_t* kRGBfamilyToYUV_UCoeffs8, COMPV_ALIGNED(DEFAULT) const int8_t* kRGBfamilyToYUV_VCoeffs8)
{
...
#if COMPV_ARCH_X86
	if (CompVCpu::isEnabled(kCpuFlagSSSE3) && COMPV_IS_ALIGNED_SSE(outUPtr) && COMPV_IS_ALIGNED_SSE(outVPtr) && COMPV_IS_ALIGNED_SSE(stride)) {
		COMPV_EXEC_IFDEF_INTRIN_X86(funcptr = CompVImageConvRgb24family_to_uv_planar_11_Intrin_SSSE3); // No need for 'rgbPtr' to be SSE-aligned
		if (COMPV_IS_ALIGNED_SSE(rgbPtr)) {
	...
	if (CompVCpu::isEnabled(kCpuFlagAVX2) && COMPV_IS_ALIGNED_AVX2(outUPtr) && COMPV_IS_ALIGNED_AVX2(outVPtr) && COMPV_IS_ALIGNED_AVX2(stride)) {
		COMPV_EXEC_IFDEF_INTRIN_X86(funcptr = CompVImageConvRgb24family_to_uv_planar_11_Intrin_AVX2); // No need for 'rgbPtr' to be AVX-aligned
		if (COMPV_IS_ALIGNED_AVX2(rgbPtr)) {
	...
	if (CompVCpu::isEnabled(kCpuFlagARM_NEON) && COMPV_IS_ALIGNED_NEON(rgbPtr) && COMPV_IS_ALIGNED_NEON(outUPtr) && COMPV_IS_ALIGNED_NEON(outVPtr) && COMPV_IS_ALIGNED_NEON(stride)) {
		...
		COMPV_EXEC_IFDEF_ASM_ARM32(funcptr = CompVImageConvRgb24family_to_uv_planar_11_Asm_NEON32);
        COMPV_EXEC_IFDEF_ASM_ARM64(funcptr = CompVImageConvRgb24family_to_uv_planar_11_Asm_NEON64);
	}
#endif
...
#elif COMPV_ARCH_ARM
	if (CompVCpu::isEnabled(kCpuFlagARM_NEON) && COMPV_IS_ALIGNED_NEON(outYPtr) && COMPV_IS_ALIGNED_NEON(stride)) {
		COMPV_EXEC_IFDEF_INTRIN_ARM(funcptr = CompVImageConvRgb32family_to_y_Intrin_NEON);
		if (COMPV_IS_ALIGNED_NEON(rgbaPtr)) {
			COMPV_EXEC_IFDEF_ASM_ARM32((
			...
			COMPV_EXEC_IFDEF_ASM_ARM64((
				funcptr = (kRGBAfamilyToYUV_YCoeffs8 == kRGBAToYUV_YCoeffs8 || kRGBAfamilyToYUV_YCoeffs8 == kBGRAToYUV_YCoeffs8)
				? CompVImageConvRgba32family_to_y_Asm_NEON64 // alpha at the last position and R,G,B at in order
				: CompVImageConvArgb32family_to_y_Asm_NEON64 // alpha at the first position and R,G,B at in order
				));
		}
    }
#endif
	...
	COMPV_ALIGNED(DEFAULT) const int8_t* kRGBfamilyToYUV_UCoeffs8, COMPV_ALIGNED(DEFAULT) const int8_t* kRGBfamilyToYUV_VCoeffs8)
{
	...
	if (CompVCpu::isEnabled(kCpuFlagARM_NEON) && COMPV_IS_ALIGNED_NEON(rgbaPtr) && COMPV_IS_ALIGNED_NEON(outUPtr) && COMPV_IS_ALIGNED_NEON(outVPtr) && COMPV_IS_ALIGNED_NEON(stride)) {
        ...
        COMPV_EXEC_IFDEF_ASM_ARM64((
            funcptr = (kRGBfamilyToYUV_UCoeffs8 == kRGBAToYUV_UCoeffs8 || kRGBfamilyToYUV_UCoeffs8 == kBGRAToYUV_UCoeffs8)
            ? CompVImageConvRgba32family_to_uv_planar_11_Asm_NEON64 // alpha at the last position and R,G,B at in order
            : CompVImageConvArgb32family_to_uv_planar_11_Asm_NEON64 // alpha at the first position and R,G,B at in order
            ));
    }
#endif
	...
	COMPV_ALIGNED(DEFAULT) const int8_t* kRGBfamilyToYUV_YCoeffs8, bool le)
{
	...
	if (CompVCpu::isEnabled(kCpuFlagARM_NEON) && COMPV_IS_ALIGNED_NEON(rgb565Ptr) && COMPV_IS_ALIGNED_NEON(outYPtr) && COMPV_IS_ALIGNED_NEON(stride)) {
		COMPV_EXEC_IFDEF_INTRIN_ARM(funcptr = le ? CompVImageConvRgb565lefamily_to_y_Intrin_NEON : CompVImageConvRgb565befamily_to_y_Intrin_NEON);
		COMPV_EXEC_IFDEF_ASM_ARM32(funcptr = le ? CompVImageConvRgb565lefamily_to_y_Asm_NEON32: CompVImageConvRgb565befamily_to_y_Asm_NEON32);
        COMPV_EXEC_IFDEF_ASM_ARM64(funcptr = le ? CompVImageConvRgb565lefamily_to_y_Asm_NEON64: CompVImageConvRgb565befamily_to_y_Asm_NEON64);
	}
#endif
...
#elif COMPV_ARCH_ARM
	if (CompVCpu::isEnabled(kCpuFlagARM_NEON) && COMPV_IS_ALIGNED_NEON(rgb565Ptr) && COMPV_IS_ALIGNED_NEON(outUPtr) && COMPV_IS_ALIGNED_NEON(outVPtr) && COMPV_IS_ALIGNED_NEON(stride)) {
		COMPV_EXEC_IFDEF_INTRIN_ARM(funcptr = le ? CompVImageConvRgb565lefamily_to_uv_planar_11_Intrin_NEON : CompVImageConvRgb565befamily_to_uv_planar_11_Intrin_NEON);
		COMPV_EXEC_IFDEF_ASM_ARM32(funcptr = le ? CompVImageConvRgb565lefamily_to_uv_planar_11_Asm_NEON32 : CompVImageConvRgb565befamily_to_uv_planar_11_Asm_NEON32);
        COMPV_EXEC_IFDEF_ASM_ARM64(funcptr = le ? CompVImageConvRgb565lefamily_to_uv_planar_11_Asm_NEON64 : CompVImageConvRgb565befamily_to_uv_planar_11_Asm_NEON64);
	}
#endif
