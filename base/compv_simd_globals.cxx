...
COMPV_BASE_API COMPV_ALIGN_DEFAULT() int32_t kShuffleEpi8_Popcnt_i32[] = { // To be used with _mm_shuffle_epi8 for popcnt computation
	COMPV_MM_SHUFFLE_EPI8(0, 1, 1, 2), COMPV_MM_SHUFFLE_EPI8(1, 2, 2, 3), COMPV_MM_SHUFFLE_EPI8(1, 2, 2, 3), COMPV_MM_SHUFFLE_EPI8(2, 3, 3, 4), // 128bits SSE register
	COMPV_MM_SHUFFLE_EPI8(0, 1, 1, 2), COMPV_MM_SHUFFLE_EPI8(1, 2, 2, 3), COMPV_MM_SHUFFLE_EPI8(1, 2, 2, 3), COMPV_MM_SHUFFLE_EPI8(2, 3, 3, 4), // 256bits AVX register
};