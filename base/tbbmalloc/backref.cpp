...
struct BackRefBlock : public BlockI {
    ...
    BackRefBlock(const BackRefBlock *blockToUse, intptr_t num) :
        ...
        freeList(NULL), nextRawMemBlock(NULL), allocatedCount(0), myNum((BackRefIdx::master_t)num),
        addedToForUse(false) {
...
bool BackRefMaster::requestNewSpace()
{
    ...
    int blocksToUse = (int)(min(numOfUnusedIdxs, blockSpaceSize / BackRefBlock::bytes));
