...
COMPV_BASE_API void * __TBB_EXPORTED_FUNC scalable_malloc (size_t size);

/** The "free" analogue to discard a previously allocated piece of memory.
    @ingroup memory_allocation */
COMPV_BASE_API void   __TBB_EXPORTED_FUNC scalable_free (void* ptr);
...
/* Ensure that including this header does not cause implicit linkage with TBB */
    ...
    #include "compv/base/tbbmalloc/tbb_stddef.h"
