...
enum COMPV_ERROR_CODE {
	...
	COMPV_ERROR_CODE_E_JSON_CPP,
	COMPV_ERROR_CODE_E_ZLIB,
	COMPV_ERROR_CODE_E_LIBSVM,
	COMPV_ERROR_CODE_E_PUGIXML,
...
enum COMPV_INTERPOLATION_TYPE {
	COMPV_INTERPOLATION_TYPE_BILINEAR, // Bilinear with output same type as input
	COMPV_INTERPOLATION_TYPE_BILINEAR_FLOAT32, // Bilinear with float32 output
	COMPV_INTERPOLATION_TYPE_BICUBIC, // Bicubic with output same type as input
	COMPV_INTERPOLATION_TYPE_BICUBIC_FLOAT32, // Bicubic with float32 output
...
enum COMPV_DISTANCE_TYPE {
	COMPV_DISTANCE_TYPE_ANGULAR,
	COMPV_DISTANCE_TYPE_EUCLIDEAN,
	COMPV_DISTANCE_TYPE_MANHATTAN,
	COMPV_DISTANCE_TYPE_HAMMING
};
