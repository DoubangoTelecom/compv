...
*/
#if !defined(_COMPV_BASE_IMAGE_THRESHOLD_INTRIN_AVX2_H_)
#define _COMPV_BASE_IMAGE_THRESHOLD_INTRIN_AVX2_H_
...
#endif /* _COMPV_BASE_IMAGE_THRESHOLD_INTRIN_AVX2_H_ */
