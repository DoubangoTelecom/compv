...
#include "compv/base/math/lmfit-6.1/lmstruct.h"

__BEGIN_DECLS

/* Levenberg-Marquardt minimization. */
COMPV_BASE_API void lmmin(const int n_par, double* par, const int m_dat, const void* data,
...
COMPV_BASE_API double lm_enorm(int, const double*);
