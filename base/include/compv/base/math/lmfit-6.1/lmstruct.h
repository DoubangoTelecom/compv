...
COMPV_BASE_API extern const lm_control_struct lm_control_double;
COMPV_BASE_API extern const lm_control_struct lm_control_float;

/* Preset message texts. */

COMPV_BASE_API extern const char* lm_infmsg[];
COMPV_BASE_API extern const char* lm_shortmsg[];
