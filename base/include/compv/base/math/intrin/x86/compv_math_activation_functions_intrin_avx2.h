...
*/
#if !defined(_COMPV_BASE_MATH_ACTIVATION_FUNCTIONS_INTRIN_AVX2_H_)
#define _COMPV_BASE_MATH_ACTIVATION_FUNCTIONS_INTRIN_AVX2_H_
...
#endif /* _COMPV_BASE_MATH_ACTIVATION_FUNCTIONS_INTRIN_AVX2_H_ */
