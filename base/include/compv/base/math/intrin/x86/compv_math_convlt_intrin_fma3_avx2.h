...
*/
#if !defined(_COMPV_BASE_MATH_CONVLT_INTRIN_FMA3_AVX2_H_)
#define _COMPV_BASE_MATH_CONVLT_INTRIN_FMA3_AVX2_H_
...
#endif /* _COMPV_BASE_MATH_CONVLT_INTRIN_FMA3_AVX2_H_ */
