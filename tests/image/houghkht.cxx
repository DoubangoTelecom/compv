...
#define HOUGHKHT_RHO						1.0f // "rho-delta" (half-pixel)
#define HOUGHKHT_THETA						1.0f // "theta-delta" (half-degree)
...
{
#if COMPV_ARCH_X86
	{ FILE_NAME_EQUIRECTANGULAR, 1282, 720, 1282, 30360.5645f, 285.553284f, 16821 },
	{ FILE_NAME_OPENGLBOOK, 200, 258, 200, 548.439331f, 217.345932f, 19176 },
	{ FILE_NAME_GRIOTS, 480, 640, 480, 3117.00000f, 68.0329437f, 5266 },
#elif COMPV_ARCH_ARM
	{ FILE_NAME_EQUIRECTANGULAR, 1282, 720, 1282, 31078.2168f, 286.338745f, 16833 },
	{ FILE_NAME_OPENGLBOOK, 200, 258, 200, 699.597473f, 260.577698f, 19708 },
	{ FILE_NAME_GRIOTS, 480, 640, 480, 3074.f, 67.4395294f, 5258 },
#else
