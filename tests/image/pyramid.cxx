...
static const struct compv_unittest_pyramid {
	COMPV_INTERPOLATION_TYPE scaleType;
...
{
	{ COMPV_INTERPOLATION_TYPE_BILINEAR, 0.5f, 6, FILE_NAME_EQUIRECTANGULAR, 1282, 720, 1282, "ea54d2b04018d355792add02535eae23" },
	{ COMPV_INTERPOLATION_TYPE_BILINEAR, 0.83f, 8, FILE_NAME_EQUIRECTANGULAR, 1282, 720, 1282, "c10b3b41a97e6416058a55cf71463409" },
	{ COMPV_INTERPOLATION_TYPE_BILINEAR, 0.99f, 3, FILE_NAME_EQUIRECTANGULAR, 1282, 720, 1282, "a9f2631d847e92fa45638523fd508cb9" },
	{ COMPV_INTERPOLATION_TYPE_BILINEAR, 0.47f, 7, FILE_NAME_EQUIRECTANGULAR, 1282, 720, 1282, "6452b6e6bb410d9457560a8bb756dd3e" },

	{ COMPV_INTERPOLATION_TYPE_BILINEAR, 0.5f, 6, FILE_NAME_OPENGLBOOK, 200, 258, 200, "b4a941a27b7d07a4ca9f3ef4e5bca69b" },
	{ COMPV_INTERPOLATION_TYPE_BILINEAR, 0.83f, 8, FILE_NAME_OPENGLBOOK, 200, 258, 200, "70901e3e2c9107eda3b4403382f4b564" },
	{ COMPV_INTERPOLATION_TYPE_BILINEAR, 0.99f, 3, FILE_NAME_OPENGLBOOK, 200, 258, 200, "64e35be23429de29cd3b5ce2ea66c6cf" },
	{ COMPV_INTERPOLATION_TYPE_BILINEAR, 0.47f, 7, FILE_NAME_OPENGLBOOK, 200, 258, 200, "94eb334401cd781bdc079c398ef4c938" },

	{ COMPV_INTERPOLATION_TYPE_BILINEAR, 0.5f, 6, FILE_NAME_GRIOTS, 480, 640, 480, "66e2b3eb67b82b8e2bf8760ca6171dc5" },
	{ COMPV_INTERPOLATION_TYPE_BILINEAR, 0.83f, 8, FILE_NAME_GRIOTS, 480, 640, 480, "47178356656332c41bd1cc30ac04fcf4" },
	{ COMPV_INTERPOLATION_TYPE_BILINEAR, 0.99f, 3, FILE_NAME_GRIOTS, 480, 640, 480, "2db1f8f8fe5cd8b73eddf059126f364e" },
	{ COMPV_INTERPOLATION_TYPE_BILINEAR, 0.47f, 7, FILE_NAME_GRIOTS, 480, 640, 480, "e11f97f76b1ede2bf883ddddd05549c1" },
};
...
#define IMAGE_PYRAMID_SCALE_TYPE	COMPV_INTERPOLATION_TYPE_BILINEAR
