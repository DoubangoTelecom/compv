...
{
	/* 0 */ { true, COMPV_SUBTYPE_RAW_UINT8, COMPV_SUBTYPE_RAW_UINT16, COMPV_SUBTYPE_RAW_UINT8, 1285, 720, 1344, 7, 7, "4a53598893aa49f05056f08983b814b2" }, // FixedPoint
	/* 1 */{ false, COMPV_SUBTYPE_RAW_UINT8, COMPV_SUBTYPE_RAW_FLOAT32, COMPV_SUBTYPE_RAW_UINT8, 1285, 720, 1344, 7, 7, "8f7c36a9b638a5b9dd41835ebb4db90e", "-" }, // FloatingPoint
	/* -2 */{ false, COMPV_SUBTYPE_RAW_UINT8, COMPV_SUBTYPE_RAW_FLOAT32, COMPV_SUBTYPE_RAW_FLOAT32, 1285, 720, 1344, 7, 7, "2434f47854ca03db2c8c5786f1ec8102", "-" }, // FloatingPoint
	/* -3 */{ false, COMPV_SUBTYPE_RAW_FLOAT32, COMPV_SUBTYPE_RAW_FLOAT32, COMPV_SUBTYPE_RAW_FLOAT32, 1285, 720, 1344, 7, 7, "751b71c49a2240571f26c78867a12db2", "-" }, // FloatingPoint
	/* -4 */{ false, COMPV_SUBTYPE_RAW_FLOAT32, COMPV_SUBTYPE_RAW_FLOAT32, COMPV_SUBTYPE_RAW_UINT8, 1285, 720, 1344, 7, 7, "30267c5a82ce9f90aee80e3f4932d49f", "-" }, // FloatingPoint
	/* 5 */{ false, COMPV_SUBTYPE_RAW_UINT8, COMPV_SUBTYPE_RAW_INT16, COMPV_SUBTYPE_RAW_INT16, 1285, 720, 1344, 7, 7, "2db0ee1fdd400debac922100fa699cf7" }, // Integer
	/* 6 */{ false, COMPV_SUBTYPE_RAW_INT16, COMPV_SUBTYPE_RAW_INT16, COMPV_SUBTYPE_RAW_INT16, 1285, 720, 1344, 7, 7, "c31158e866321490ea9aa83c6fb55216" }, // Integer
};
