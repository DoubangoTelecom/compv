...
#define LOOP_COUNT				1
#define INTERP_TYPE				COMPV_INTERPOLATION_TYPE_NEAREST
...
{
	CompVMatPtr distortedImage, undistortedImage;
	COMPV_CHECK_CODE_RETURN(CompVImage::readPixels(COMPV_SUBTYPE_PIXELS_Y, 640, 360, 640, COMPV_TEST_PATH_TO_FILE("distorted_640x360_gray.yuv").c_str(), &distortedImage));
	...
	*d->ptr<double>(3, 0) = CAMERA_INFO_DIST_P2;
	...
	for (size_t i = 0; i < LOOP_COUNT; ++i) {
		COMPV_CHECK_CODE_RETURN(CompVCalibUtils::undist2DImage(distortedImage, K, d, &undistortedImage, INTERP_TYPE));
	}
