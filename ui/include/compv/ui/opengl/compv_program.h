...
*/
#if !defined(_COMPV_UI_OPENGL_PROGRAM_H_)
#define _COMPV_UI_OPENGL_PROGRAM_H_
...
class COMPV_UI_API CompVProgram : public CompVObj
{
protected:
	CompVProgram();
public:
...
#endif /* _COMPV_UI_OPENGL_PROGRAM_H_ */
