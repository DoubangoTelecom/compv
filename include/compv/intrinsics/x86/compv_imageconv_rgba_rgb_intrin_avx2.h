...
* along with CompV.
*/
#if !defined(_COMPV_IMAGE_IMAGECONV_RGBA_RGB_INTRIN_AVX2_H_)
#define _COMPV_IMAGE_IMAGECONV_RGBA_RGB_INTRIN_AVX2_H_
...
#endif /* _COMPV_IMAGE_IMAGECONV_RGBA_RGB_INTRIN_AVX2_H_ */
