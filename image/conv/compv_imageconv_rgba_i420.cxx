...
// SSSE3
COMPV_EXTERNC void rgbaToI420Kernel11_CompY_Asm_X86_Aligned1x_SSSE3(COMPV_ALIGNED(SSE) const uint8_t* rgbaPtr, uint8_t* outYPtr, compv_scalar_t height, compv_scalar_t width, compv_scalar_t stride, COMPV_ALIGNED(SSE) const int8_t* kXXXXToYUV_YCoeffs8);
COMPV_EXTERNC void rgbaToI420Kernel11_CompY_Asm_X86_Aligned0x_SSSE3(const uint8_t* rgbaPtr, uint8_t* outYPtr, compv_scalar_t height, compv_scalar_t width, compv_scalar_t stride, COMPV_ALIGNED(SSE) const int8_t* kXXXXToYUV_YCoeffs8);
COMPV_EXTERNC void rgbaToI420Kernel41_CompY_Asm_X86_Aligned00_SSSE3(const uint8_t* rgbaPtr, uint8_t* outYPtr, compv_scalar_t height, compv_scalar_t width, compv_scalar_t stride, COMPV_ALIGNED(SSE) const int8_t* kXXXXToYUV_YCoeffs8);
COMPV_EXTERNC void rgbaToI420Kernel41_CompY_Asm_X86_Aligned01_SSSE3(const uint8_t* rgbaPtr, COMPV_ALIGNED(SSE) uint8_t* outYPtr, compv_scalar_t height, compv_scalar_t width, compv_scalar_t stride, COMPV_ALIGNED(SSE) const int8_t* kXXXXToYUV_YCoeffs8);
COMPV_EXTERNC void rgbaToI420Kernel41_CompY_Asm_X86_Aligned10_SSSE3(COMPV_ALIGNED(SSE) const uint8_t* rgbaPtr, uint8_t* outYPtr, compv_scalar_t height, compv_scalar_t width, compv_scalar_t stride, COMPV_ALIGNED(SSE) const int8_t* kXXXXToYUV_YCoeffs8);
COMPV_EXTERNC void rgbaToI420Kernel41_CompY_Asm_X86_Aligned11_SSSE3(COMPV_ALIGNED(SSE) const uint8_t* rgbaPtr, COMPV_ALIGNED(SSE) uint8_t* outYPtr, compv_scalar_t height, compv_scalar_t width, compv_scalar_t stride, COMPV_ALIGNED(SSE) const int8_t* kXXXXToYUV_YCoeffs8);

COMPV_EXTERNC void rgbaToI420Kernel11_CompUV_Asm_X86_Aligned0xx_SSSE3(const uint8_t* rgbaPtr, uint8_t* outUPtr, uint8_t* outVPtr, compv_scalar_t height, compv_scalar_t width, compv_scalar_t stride, COMPV_ALIGNED(SSE) const int8_t* kXXXXToYUV_UCoeffs8, COMPV_ALIGNED(SSE) const int8_t* kXXXXToYUV_VCoeffs8);
COMPV_EXTERNC void rgbaToI420Kernel11_CompUV_Asm_X86_Aligned1xx_SSSE3(COMPV_ALIGNED(SSE) const uint8_t* rgbaPtr, uint8_t* outUPtr, uint8_t* outVPtr, compv_scalar_t height, compv_scalar_t width, compv_scalar_t stride, COMPV_ALIGNED(SSE) const int8_t* kXXXXToYUV_UCoeffs8, COMPV_ALIGNED(SSE) const int8_t* kXXXXToYUV_VCoeffs8);
COMPV_EXTERNC void rgbaToI420Kernel41_CompUV_Asm_X86_Aligned1xx_SSSE3(COMPV_ALIGNED(SSE) const uint8_t* rgbaPtr, uint8_t* outUPtr, uint8_t* outVPtr, compv_scalar_t height, compv_scalar_t width, compv_scalar_t stride, COMPV_ALIGNED(SSE) const int8_t* kXXXXToYUV_UCoeffs8, COMPV_ALIGNED(SSE) const int8_t* kXXXXToYUV_VCoeffs8);
COMPV_EXTERNC void rgbaToI420Kernel41_CompUV_Asm_X86_Aligned0xx_SSSE3(COMPV_ALIGNED(SSE) const uint8_t* rgbaPtr, uint8_t* outUPtr, uint8_t* outVPtr, compv_scalar_t height, compv_scalar_t width, compv_scalar_t stride, COMPV_ALIGNED(SSE) const int8_t* kXXXXToYUV_UCoeffs8, COMPV_ALIGNED(SSE) const int8_t* kXXXXToYUV_VCoeffs8);

COMPV_EXTERNC void rgbToI420Kernel31_CompY_Asm_X86_Aligned00_SSSE3(COMPV_ALIGNED(SSE) const uint8_t* rgbaPtr, COMPV_ALIGNED(SSE) uint8_t* outYPtr, compv_scalar_t height, compv_scalar_t width, compv_scalar_t stride, COMPV_ALIGNED(SSE) const int8_t* kXXXXToYUV_YCoeffs8);
COMPV_EXTERNC void rgbToI420Kernel31_CompY_Asm_X86_Aligned01_SSSE3(COMPV_ALIGNED(SSE) const uint8_t* rgbaPtr, COMPV_ALIGNED(SSE) uint8_t* outYPtr, compv_scalar_t height, compv_scalar_t width, compv_scalar_t stride, COMPV_ALIGNED(SSE) const int8_t* kXXXXToYUV_YCoeffs8);
COMPV_EXTERNC void rgbToI420Kernel31_CompY_Asm_X86_Aligned10_SSSE3(COMPV_ALIGNED(SSE) const uint8_t* rgbaPtr, COMPV_ALIGNED(SSE) uint8_t* outYPtr, compv_scalar_t height, compv_scalar_t width, compv_scalar_t stride, COMPV_ALIGNED(SSE) const int8_t* kXXXXToYUV_YCoeffs8);
COMPV_EXTERNC void rgbToI420Kernel31_CompY_Asm_X86_Aligned11_SSSE3(COMPV_ALIGNED(SSE) const uint8_t* rgbaPtr, COMPV_ALIGNED(SSE) uint8_t* outYPtr, compv_scalar_t height, compv_scalar_t width, compv_scalar_t stride, COMPV_ALIGNED(SSE) const int8_t* kXXXXToYUV_YCoeffs8);

COMPV_EXTERNC void rgbToI420Kernel31_CompUV_Asm_X86_Aligned0xx_SSSE3(const uint8_t* rgbaPtr, uint8_t* outUPtr, uint8_t* outVPtr, compv_scalar_t height, compv_scalar_t width, compv_scalar_t stride, COMPV_ALIGNED(SSE) const int8_t* kXXXXToYUV_UCoeffs8, COMPV_ALIGNED(SSE) const int8_t* kXXXXToYUV_VCoeffs8);
COMPV_EXTERNC void rgbToI420Kernel31_CompUV_Asm_X86_Aligned1xx_SSSE3(COMPV_ALIGNED(SSE) const uint8_t* rgbaPtr, uint8_t* outUPtr, uint8_t* outVPtr, compv_scalar_t height, compv_scalar_t width, compv_scalar_t stride, COMPV_ALIGNED(SSE) const int8_t* kXXXXToYUV_UCoeffs8, COMPV_ALIGNED(SSE) const int8_t* kXXXXToYUV_VCoeffs8);

COMPV_EXTERNC void i420ToRGBAKernel11_Asm_X86_Aligned00_SSSE3(const uint8_t* yPtr, const uint8_t* uPtr, const uint8_t* vPtr, uint8_t* outRgbaPtr, compv_scalar_t height, compv_scalar_t width, compv_scalar_t stride);
COMPV_EXTERNC void i420ToRGBAKernel11_Asm_X86_Aligned01_SSSE3(const uint8_t* yPtr, const uint8_t* uPtr, const uint8_t* vPtr, COMPV_ALIGNED(SSE) uint8_t* outRgbaPtr, compv_scalar_t height, compv_scalar_t width, compv_scalar_t stride);
COMPV_EXTERNC void i420ToRGBAKernel11_Asm_X86_Aligned10_SSSE3(COMPV_ALIGNED(SSE) const uint8_t* yPtr, const uint8_t* uPtr, const uint8_t* vPtr, uint8_t* outRgbaPtr, compv_scalar_t height, compv_scalar_t width, compv_scalar_t stride);
COMPV_EXTERNC void i420ToRGBAKernel11_Asm_X86_Aligned11_SSSE3(COMPV_ALIGNED(SSE) const uint8_t* yPtr, const uint8_t* uPtr, const uint8_t* vPtr, COMPV_ALIGNED(SSE) uint8_t* outRgbaPtr, compv_scalar_t height, compv_scalar_t width, compv_scalar_t stride);

// AVX2-X86
COMPV_EXTERNC void rgbaToI420Kernel11_CompY_Asm_X86_Aligned0_AVX2(const uint8_t* rgbaPtr, uint8_t* outYPtr, compv_scalar_t height, compv_scalar_t width, compv_scalar_t stride, COMPV_ALIGNED(AVX2) const int8_t* kXXXXToYUV_YCoeffs8);
COMPV_EXTERNC void rgbaToI420Kernel11_CompY_Asm_X86_Aligned1_AVX2(COMPV_ALIGNED(AVX2) const uint8_t* rgbaPtr, uint8_t* outYPtr, compv_scalar_t height, compv_scalar_t width, compv_scalar_t stride, COMPV_ALIGNED(AVX2) const int8_t* kXXXXToYUV_YCoeffs8);
COMPV_EXTERNC void rgbaToI420Kernel41_CompY_Asm_X86_Aligned00_AVX2(const uint8_t* rgbaPtr, uint8_t* outYPtr, compv_scalar_t height, compv_scalar_t width, compv_scalar_t stride, COMPV_ALIGNED(AVX2) const int8_t* kXXXXToYUV_YCoeffs8);
COMPV_EXTERNC void rgbaToI420Kernel41_CompY_Asm_X86_Aligned01_AVX2(const uint8_t* rgbaPtr, COMPV_ALIGNED(AVX2) uint8_t* outYPtr, compv_scalar_t height, compv_scalar_t width, compv_scalar_t stride, COMPV_ALIGNED(AVX2) const int8_t* kXXXXToYUV_YCoeffs8);
COMPV_EXTERNC void rgbaToI420Kernel41_CompY_Asm_X86_Aligned10_AVX2(COMPV_ALIGNED(AVX2) const uint8_t* rgbaPtr, uint8_t* outYPtr, compv_scalar_t height, compv_scalar_t width, compv_scalar_t stride, COMPV_ALIGNED(AVX2) const int8_t* kXXXXToYUV_YCoeffs8);
COMPV_EXTERNC void rgbaToI420Kernel41_CompY_Asm_X86_Aligned11_AVX2(COMPV_ALIGNED(AVX2) const uint8_t* rgbaPtr, COMPV_ALIGNED(AVX2) uint8_t* outYPtr, compv_scalar_t height, compv_scalar_t width, compv_scalar_t stride, COMPV_ALIGNED(AVX2) const int8_t* kXXXXToYUV_YCoeffs8);

COMPV_EXTERNC void rgbaToI420Kernel11_CompUV_Asm_X86_Aligned0xx_AVX2(const uint8_t* rgbaPtr, uint8_t* outUPtr, uint8_t* outVPtr, compv_scalar_t height, compv_scalar_t width, compv_scalar_t stride, COMPV_ALIGNED(AVX2) const int8_t* kXXXXToYUV_UCoeffs8, COMPV_ALIGNED(AVX2) const int8_t* kXXXXToYUV_VCoeffs8);
COMPV_EXTERNC void rgbaToI420Kernel11_CompUV_Asm_X86_Aligned1xx_AVX2(COMPV_ALIGNED(AVX2) const uint8_t* rgbaPtr, uint8_t* outUPtr, uint8_t* outVPtr, compv_scalar_t height, compv_scalar_t width, compv_scalar_t stride, COMPV_ALIGNED(AVX2) const int8_t* kXXXXToYUV_UCoeffs8, COMPV_ALIGNED(AVX2) const int8_t* kXXXXToYUV_VCoeffs8);
COMPV_EXTERNC void rgbaToI420Kernel41_CompUV_Asm_X86_Aligned000_AVX2(const uint8_t* rgbaPtr, uint8_t* outUPtr, uint8_t* outVPtr, compv_scalar_t height, compv_scalar_t width, compv_scalar_t stride, COMPV_ALIGNED(AVX2) const int8_t* kXXXXToYUV_UCoeffs8, COMPV_ALIGNED(AVX2) const int8_t* kXXXXToYUV_VCoeffs8);
COMPV_EXTERNC void rgbaToI420Kernel41_CompUV_Asm_X86_Aligned100_AVX2(COMPV_ALIGNED(AVX2) const uint8_t* rgbaPtr, uint8_t* outUPtr, uint8_t* outVPtr, compv_scalar_t height, compv_scalar_t width, compv_scalar_t stride, COMPV_ALIGNED(AVX2) const int8_t* kXXXXToYUV_UCoeffs8, COMPV_ALIGNED(AVX2) const int8_t* kXXXXToYUV_VCoeffs8);
COMPV_EXTERNC void rgbaToI420Kernel41_CompUV_Asm_X86_Aligned110_AVX2(COMPV_ALIGNED(AVX2) const uint8_t* rgbaPtr, COMPV_ALIGNED(SSE) uint8_t* outUPtr, uint8_t* outVPtr, compv_scalar_t height, compv_scalar_t width, compv_scalar_t stride, COMPV_ALIGNED(AVX2) const int8_t* kXXXXToYUV_UCoeffs8, COMPV_ALIGNED(AVX2) const int8_t* kXXXXToYUV_VCoeffs8);
COMPV_EXTERNC void rgbaToI420Kernel41_CompUV_Asm_X86_Aligned111_AVX2(COMPV_ALIGNED(AVX2) const uint8_t* rgbaPtr, COMPV_ALIGNED(SSE) uint8_t* outUPtr, COMPV_ALIGNED(SSE) uint8_t* outVPtr, compv_scalar_t height, compv_scalar_t width, compv_scalar_t stride, COMPV_ALIGNED(AVX2) const int8_t* kXXXXToYUV_UCoeffs8, COMPV_ALIGNED(AVX2) const int8_t* kXXXXToYUV_VCoeffs8);

COMPV_EXTERNC void rgbToI420Kernel31_CompY_Asm_X86_Aligned00_AVX2(const uint8_t* rgbaPtr, uint8_t* outYPtr, compv_scalar_t height, compv_scalar_t width, compv_scalar_t stride, COMPV_ALIGNED(AVX2) const int8_t* kXXXXToYUV_YCoeffs8);
COMPV_EXTERNC void rgbToI420Kernel31_CompY_Asm_X86_Aligned01_AVX2(const uint8_t* rgbaPtr, COMPV_ALIGNED(AVX2) uint8_t* outYPtr, compv_scalar_t height, compv_scalar_t width, compv_scalar_t stride, COMPV_ALIGNED(AVX2) const int8_t* kXXXXToYUV_YCoeffs8);
COMPV_EXTERNC void rgbToI420Kernel31_CompY_Asm_X86_Aligned10_AVX2(COMPV_ALIGNED(AVX2) const uint8_t* rgbaPtr, uint8_t* outYPtr, compv_scalar_t height, compv_scalar_t width, compv_scalar_t stride, COMPV_ALIGNED(AVX2) const int8_t* kXXXXToYUV_YCoeffs8);
COMPV_EXTERNC void rgbToI420Kernel31_CompY_Asm_X86_Aligned11_AVX2(COMPV_ALIGNED(AVX2) const uint8_t* rgbaPtr, COMPV_ALIGNED(AVX2) uint8_t* outYPtr, compv_scalar_t height, compv_scalar_t width, compv_scalar_t stride, COMPV_ALIGNED(AVX2) const int8_t* kXXXXToYUV_YCoeffs8);

COMPV_EXTERNC void rgbToI420Kernel31_CompUV_Asm_X86_Aligned000_AVX2(const uint8_t* rgbaPtr, uint8_t* outUPtr, uint8_t* outVPtr, compv_scalar_t height, compv_scalar_t width, compv_scalar_t stride, COMPV_ALIGNED(AVX2) const int8_t* kXXXXToYUV_UCoeffs8, COMPV_ALIGNED(AVX2) const int8_t* kXXXXToYUV_VCoeffs8);
COMPV_EXTERNC void rgbToI420Kernel31_CompUV_Asm_X86_Aligned100_AVX2(COMPV_ALIGNED(AVX2) const uint8_t* rgbaPtr, uint8_t* outUPtr, uint8_t* outVPtr, compv_scalar_t height, compv_scalar_t width, compv_scalar_t stride, COMPV_ALIGNED(AVX2) const int8_t* kXXXXToYUV_UCoeffs8, COMPV_ALIGNED(AVX2) const int8_t* kXXXXToYUV_VCoeffs8);
COMPV_EXTERNC void rgbToI420Kernel31_CompUV_Asm_X86_Aligned110_AVX2(COMPV_ALIGNED(AVX2) const uint8_t* rgbaPtr, COMPV_ALIGNED(SSE) uint8_t* outUPtr, uint8_t* outVPtr, compv_scalar_t height, compv_scalar_t width, compv_scalar_t stride, COMPV_ALIGNED(AVX2) const int8_t* kXXXXToYUV_UCoeffs8, COMPV_ALIGNED(AVX2) const int8_t* kXXXXToYUV_VCoeffs8);
COMPV_EXTERNC void rgbToI420Kernel31_CompUV_Asm_X86_Aligned111_AVX2(COMPV_ALIGNED(AVX2) const uint8_t* rgbaPtr, COMPV_ALIGNED(SSE) uint8_t* outUPtr, COMPV_ALIGNED(SSE) uint8_t* outVPtr, compv_scalar_t height, compv_scalar_t width, compv_scalar_t stride, COMPV_ALIGNED(AVX2) const int8_t* kXXXXToYUV_UCoeffs8, COMPV_ALIGNED(AVX2) const int8_t* kXXXXToYUV_VCoeffs8);

COMPV_EXTERNC void i420ToRGBAKernel11_Asm_X86_Aligned00_AVX2(const uint8_t* yPtr, const uint8_t* uPtr, const uint8_t* vPtr, uint8_t* outRgbaPtr, compv_scalar_t height, compv_scalar_t width, compv_scalar_t stride);
COMPV_EXTERNC void i420ToRGBAKernel11_Asm_X86_Aligned01_AVX2(const uint8_t* yPtr, const uint8_t* uPtr, const uint8_t* vPtr, COMPV_ALIGNED(AVX2) uint8_t* outRgbaPtr, compv_scalar_t height, compv_scalar_t width, compv_scalar_t stride);
COMPV_EXTERNC void i420ToRGBAKernel11_Asm_X86_Aligned10_AVX2(COMPV_ALIGNED(AVX2) const uint8_t* yPtr, const uint8_t* uPtr, const uint8_t* vPtr, uint8_t* outRgbaPtr, compv_scalar_t height, compv_scalar_t width, compv_scalar_t stride);
COMPV_EXTERNC void i420ToRGBAKernel11_Asm_X86_Aligned11_AVX2(COMPV_ALIGNED(AVX2) const uint8_t* yPtr, const uint8_t* uPtr, const uint8_t* vPtr, COMPV_ALIGNED(AVX2) uint8_t* outRgbaPtr, compv_scalar_t height, compv_scalar_t width, compv_scalar_t stride);
