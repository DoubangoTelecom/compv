...
public:
    ...
    bool twoSidedStencilSupport() const {
        return fTwoSidedStencilSupport;
    }
    bool stencilWrapOpsSupport() const {
    ...
    bool compressedTexSubImageSupport() const {
        return fCompressedTexSubImageSupport;
    }
