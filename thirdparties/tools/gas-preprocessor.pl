...
# Added by Doubango Telcom: gas-preprocessor doesn't support neon register aliases included
# from another file. Here we define the built-in aliases from compv_commo_arm.s
...
########################################################################
# Doubango Telecom: Add global aliases from compv_common_arm.S
# gas-preprocessor doesn't export aliases from included files.
$neon_alias_reg{q0x} = "d0";
$neon_alias_reg{q0y} = "d1";
$neon_alias_reg{q1x} = "d2";
$neon_alias_reg{q1y} = "d3";
$neon_alias_reg{q2x} = "d4";
$neon_alias_reg{q2y} = "d5";
$neon_alias_reg{q3x} = "d6";
$neon_alias_reg{q3y} = "d7";
$neon_alias_reg{q4x} = "d8";
$neon_alias_reg{q4y} = "d9";
$neon_alias_reg{q5x} = "d10";
$neon_alias_reg{q5y} = "d11";
$neon_alias_reg{q6x} = "d12";
$neon_alias_reg{q6y} = "d13";
$neon_alias_reg{q7x} = "d14";
$neon_alias_reg{q7y} = "d15";
$neon_alias_reg{q8x} = "d16";
$neon_alias_reg{q8y} = "d17";
$neon_alias_reg{q9x} = "d18";
$neon_alias_reg{q9y} = "d19";
$neon_alias_reg{q10x} = "d20";
$neon_alias_reg{q10y} = "d21";
$neon_alias_reg{q11x} = "d22";
$neon_alias_reg{q11y} = "d23";
$neon_alias_reg{q12x} = "d24";
$neon_alias_reg{q12y} = "d25";
$neon_alias_reg{q13x} = "d26";
$neon_alias_reg{q13y} = "d27";
$neon_alias_reg{q14x} = "d28";
$neon_alias_reg{q14y} = "d29";
$neon_alias_reg{q15x} = "d30";
$neon_alias_reg{q15y} = "d31";
$neon_alias_type{q0x} = "";
$neon_alias_type{q0y} = "";
$neon_alias_type{q1x} = "";
$neon_alias_type{q1y} = "";
...
$neon_alias_type{q9x} = "";
$neon_alias_type{q9y} = "";
$neon_alias_type{q10x} = "";
$neon_alias_type{q10y} = "";
$neon_alias_type{q11x} = "";
$neon_alias_type{q11y} = "";
$neon_alias_type{q12x} = "";
$neon_alias_type{q12y} = "";
$neon_alias_type{q13x} = "";
$neon_alias_type{q13y} = "";
$neon_alias_type{q14x} = "";
$neon_alias_type{q14y} = "";
$neon_alias_type{q15x} = "";
$neon_alias_type{q15y} = "";
########################################################################
...
if (scalar keys %neon_alias_reg > 0 && $line =~ /^\s+v\w+/) {
    ...
    # or .req which possiblity requires replacing the aliases
