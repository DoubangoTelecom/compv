...
*/
#if !defined(_COMPV_DRAWING_SURFACE_LAYER_MATCHING_H_)
#define _COMPV_DRAWING_SURFACE_LAYER_MATCHING_H_
...
class COMPV_DRAWING_API CompVMatchingSurfaceLayer : public CompVSurfaceLayer
{
protected:
...
#endif /* _COMPV_DRAWING_SURFACE_LAYER_MATCHING_H_ */
