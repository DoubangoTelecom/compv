...
*/
#if !defined(_COMPV_DRAWING_SURFACE_LAYER_MULTI_H_)
#define _COMPV_DRAWING_SURFACE_LAYER_MULTI_H_
...
class COMPV_DRAWING_API CompVMultiSurfaceLayer : public CompVSurfaceLayer
{
protected:
...
#endif /* _COMPV_DRAWING_SURFACE_LAYER_MULTI_H_ */
