...
// FIXME: replace with COMPV_DEBUG_...
...
static struct android_app* android_app_create(ANativeActivity* activity,
	...
	struct android_app* android_app = static_cast<struct android_app*>(compv::CompVMem::malloc(sizeof(struct android_app)));
	...
	if (savedState != NULL) {
		android_app->savedState = compv::CompVMem::malloc(savedStateSize);
