...
public:
	...
	COMPV_INLINE bool isConnected()const { return m_bConnect; }
	COMPV_INLINE bool isStarted()const { return m_bStart; }
	COMPV_INLINE const AM_MEDIA_TYPE& connectedMediaType()const { return m_ConnectedMediaType; }
