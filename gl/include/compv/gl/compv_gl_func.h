...
#define COMPV_glBlendFunc(...)						glBlendFunc(__VA_ARGS__); COMPV_GL_CHECK_ERROR("glBlendFunc", __LINE__)
#define COMPV_glBufferSubData(...)					glBufferSubData(__VA_ARGS__); COMPV_GL_CHECK_ERROR("glBlendFunc", __LINE__)
#define COMPV_glBufferData(...)						glBufferData(__VA_ARGS__); COMPV_GL_CHECK_ERROR("glBufferData", __LINE__)
#define COMPV_glCheckFramebufferStatus( ...)	    glCheckFramebufferStatus(__VA_ARGS__); COMPV_GL_CHECK_ERROR("glBufferData", __LINE__)
...
#define COMPV_glDrawArrays(...)						glDrawArrays(__VA_ARGS__); COMPV_GL_CHECK_ERROR("glDrawArrays", __LINE__)
#define COMPV_glDrawElements(...)					glDrawElements(__VA_ARGS__); COMPV_GL_CHECK_ERROR("glDrawElements", __LINE__)
#define COMPV_glEnable(...)							glEnable(__VA_ARGS__); COMPV_GL_CHECK_ERROR("glEnable", __LINE__)
...
#define COMPV_glGetAttribLocation(...)				glGetAttribLocation(__VA_ARGS__); COMPV_GL_CHECK_ERROR("glGetAttribLocation", __LINE__)
...
#define COMPV_glGetUniformLocation( ...)			glGetUniformLocation(__VA_ARGS__); COMPV_GL_CHECK_ERROR("glGetUniformLocation", __LINE__)
#define COMPV_glHint(...)							glHint(__VA_ARGS__); COMPV_GL_CHECK_ERROR("glHint", __LINE__)
#define COMPV_glLineWidth(...)						glLineWidth(__VA_ARGS__); COMPV_GL_CHECK_ERROR("glLineWidth", __LINE__)
...
#define COMPV_glUniform1f(...)						glUniform1f(__VA_ARGS__); COMPV_GL_CHECK_ERROR("glUniform1f", __LINE__)
#define COMPV_glUniform2fv(...)						glUniform2fv(__VA_ARGS__); COMPV_GL_CHECK_ERROR("glUniform2fv", __LINE__)
#define COMPV_glUniform2iv(...)						glUniform2iv(__VA_ARGS__); COMPV_GL_CHECK_ERROR("glUniform2iv", __LINE__)
#define COMPV_glUniform4f(...)						glUniform4f(__VA_ARGS__); COMPV_GL_CHECK_ERROR("glUniform4f", __LINE__)
