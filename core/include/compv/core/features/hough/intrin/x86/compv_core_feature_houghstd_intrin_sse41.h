...
*/
#if !defined(_COMPV_CORE_FEATURE_HOUGHSTD_INTRIN_SSE41_H_)
#define _COMPV_CORE_FEATURE_HOUGHSTD_INTRIN_SSE41_H_
...
#endif /* _COMPV_CORE_FEATURE_HOUGHSTD_INTRIN_SSE41_H_ */
