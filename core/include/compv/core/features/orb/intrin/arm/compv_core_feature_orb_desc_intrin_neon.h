...
*/
#if !defined(_COMPV_CORE_FEATURES_ORB_DESC_INTRIN_NEON_H_)
#define _COMPV_CORE_FEATURES_ORB_DESC_INTRIN_NEON_H_
...
#endif /* _COMPV_CORE_FEATURES_ORB_DESC_INTRIN_NEON_H_ */
