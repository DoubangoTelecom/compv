...
*/
#if !defined(_COMPV_CORE_FEATURE_HOG_STD_INTRIN_NEON_H_)
#define _COMPV_CORE_FEATURE_HOG_STD_INTRIN_NEON_H_
...
void CompVHogStdBuildMapHistForSingleCellBilinear_32f32s_Intrin_NEON(
	...
	COMPV_ALIGNED(NEON) const compv_uscalar_t cellWidth,
...
#endif /* _COMPV_CORE_FEATURE_HOG_STD_INTRIN_NEON_H_ */
