...
*/
#if !defined(_COMPV_CORE_FEATURE_HOG_COMMON_NORM_INTRIN_SSE2_H_)
#define _COMPV_CORE_FEATURE_HOG_COMMON_NORM_INTRIN_SSE2_H_
...
#endif /* _COMPV_CORE_FEATURE_HOG_COMMON_NORM_INTRIN_SSE2_H_ */
