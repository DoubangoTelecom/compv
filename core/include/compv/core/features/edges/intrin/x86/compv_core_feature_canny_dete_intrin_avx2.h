...
*/
#if !defined(_COMPV_CORE_FETAURE_CANNY_DETE_INTRIN_AVX2_H_)
#define _COMPV_CORE_FETAURE_CANNY_DETE_INTRIN_AVX2_H_
...
#endif /* _COMPV_CORE_FETAURE_CANNY_DETE_INTRIN_AVX2_H_ */
