...
*/
#if !defined(_COMPV_CORE_FEATURES_FAST_DETE_INTRIN_NEON_H_)
#define _COMPV_CORE_FEATURES_FAST_DETE_INTRIN_NEON_H_
...
#endif /* _COMPV_CORE_FEATURES_FAST_DETE_INTRIN_NEON_H_ */
