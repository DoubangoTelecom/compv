...
)
{
	...
	const __m256i vecStride = _mm256_set1_epi32(static_cast<int>(img_stride));
	...
	for (size_t i = 0; i < 256; i += 32) {
		...
		vecX[2] = _mm256_cvtps_epi32(_mm256_castsi256_ps(vecX[2]));
		vecX[3] = _mm256_cvtps_epi32(_mm256_castsi256_ps(vecX[3]));
		// y = COMPV_MATH_ROUNDF_2_NEAREST_INT(yf, int);
		vecY[0] = _mm256_cvtps_epi32(_mm256_castsi256_ps(vecY[0]));
		vecY[1] = _mm256_cvtps_epi32(_mm256_castsi256_ps(vecY[1]));
		vecY[2] = _mm256_cvtps_epi32(_mm256_castsi256_ps(vecY[2]));
		vecY[3] = _mm256_cvtps_epi32(_mm256_castsi256_ps(vecY[3]));
		// a = img_center[(y * img_stride) + x];
		_mm256_store_si256(reinterpret_cast<__m256i*>(&vecIndex[0]), _mm256_add_epi32(_mm256_mullo_epi32(vecY[0], vecStride), vecX[0]));
		_mm256_store_si256(reinterpret_cast<__m256i*>(&vecIndex[8]), _mm256_add_epi32(_mm256_mullo_epi32(vecY[1], vecStride), vecX[1]));
		_mm256_store_si256(reinterpret_cast<__m256i*>(&vecIndex[16]), _mm256_add_epi32(_mm256_mullo_epi32(vecY[2], vecStride), vecX[2]));
		_mm256_store_si256(reinterpret_cast<__m256i*>(&vecIndex[24]), _mm256_add_epi32(_mm256_mullo_epi32(vecY[3], vecStride), vecX[3]));
