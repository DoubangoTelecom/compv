...
)
{
	...
	for (size_t i = 0; i < 256; i += 16) {
		...
		_mm_store_si128(reinterpret_cast<__m128i*>(&vecIndex[0]), _mm_add_epi32(_mm_mullo_epi32(vecY[0], vecStride), vecX[0]));
		_mm_store_si128(reinterpret_cast<__m128i*>(&vecIndex[4]), _mm_add_epi32(_mm_mullo_epi32(vecY[1], vecStride), vecX[1]));
		_mm_store_si128(reinterpret_cast<__m128i*>(&vecIndex[8]), _mm_add_epi32(_mm_mullo_epi32(vecY[2], vecStride), vecX[2]));
		_mm_store_si128(reinterpret_cast<__m128i*>(&vecIndex[12]), _mm_add_epi32(_mm_mullo_epi32(vecY[3], vecStride), vecX[3]));
